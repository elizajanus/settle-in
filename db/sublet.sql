...
INSERT INTO sublet (title, [description], rent, roommates, female, male, city, [location], landlord, managementContactInfo) values ("Oregon Hill/VCU Room", "Large first floor bedroom available. Come live with rising Juniors at VCU!", 500, 2, 2, 1, 1, 1, "Richmond", "Pine St at Spring St", "Reynholm Industries", "804-555-6667");
INSERT INTO sublet (title, [description], rent, roommates, female, male, city, [location], landlord, managementContactInfo) values ("Female Roommate Needed", "Join us in the large townhome only minutes from MCV campus and walking distance to restaurants and stores!", 500, 2.5, 3, 1, 0, 0, "Richmond", "Leigh St at James St", "RVApts", "804-555-3456");
