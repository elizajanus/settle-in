...
INSERT INTO sublet (title, [description], rent, roommates, female, male, city, [location], landlord, managementContactInfo) values ("Female Roommate Needed", "Joing us in the large townhome only minutes from MCV campus and walking distance to restaurants and stores!", 500, 2.5, 3, 1, 0, 0, "Richmond", "Leigh St at James St", "RVApts");
